...
md5sum CMMR16SV4Pipeline.md Demultiplex_Sheet.txt Merged_Barcodes.fq.bz2 Merged_Reads.fq.bz2 Raw_Read1.fq.bz2 Raw_Read2_Barcodes.fq.bz2 Raw_Read3.fq.bz2 > SRD2.Upload.MD5Sums.txt;
zip -0 ${TMPDIR}/${file}.zip CMMR16SV4Pipeline.md Demultiplex_Sheet.txt Merged_Barcodes.fq.bz2 Merged_Reads.fq.bz2 Raw_Read1.fq.bz2 Raw_Read2_Barcodes.fq.bz2 Raw_Read3.fq.bz2 SRD2.Upload.MD5Sums.txt;
sum=`md5sum ${TMPDIR}/${file}.zip | sed -e "s:${TMPDIR}\/::g"`;
