...
${WONGGITREPO}/16S_workflows/resolveIterativeUparse.pl ${TMPDIR}/uparseStrict/cluster_*.uc ${TMPDIR}/uparseStrict/singletons2otus.uc ${TMPDIR}/uparseStrict/otus2taxa.uc --derep ${TMPDIR}/uparseStrict/derep.uc --chimeras ${TMPDIR}/uparseStrict/chimeras.txt --uchime ${TMPDIR}/uparseStrict/uchimeref.uc --taxonomy ${SILVA}/silva.map;
