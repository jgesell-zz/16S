...
mv ${TMPDIR}/seqs.raw.filtered.fq ${TMPDIR}/Raw_Reads_Temp.fq;
fq2fa ${TMPDIR}/Raw_Reads_Temp.fq ${TMPDIR}/Raw_Reads_Temp.fa;
...
cat ${TMPDIR}/Raw_Reads_Temp.fa >> ${TMPDIR}/Raw_Reads.fa;
...
cat ${TMPDIR}/Merged_Reads.fq | perl ${GITREPO}/Miscellaneous/fastqfilter.pl -v ${TMPDIR}/Remove > ${TMPDIR}/TempMerged_Reads.fq &
